...
function App() {
  ...
  useEffect(() => { 
    const interval = setInterval(() => {   //this gonna be usefull to automatic refresh 
      fetchCryptoData();
  ...
  const fetchCryptoData = async () => {
   ...
   // console.log(sortedData);
    //to set the cryptodata to be the one we fetch
    setCryptoData(sortedData);
  }
///////////////////////data with the tailwind styles///////////////
  return (
    <div className="container mx-auto px-4 sm:px-8">
  <div className="py-8">
    <div>
      <h2 className="text-2xl font-semibold leading-tight">Crypto Ranking Table (value on real time)</h2>
    </div>
